                                ...
                                <form action="{{ route('guardar_actualizar_revisor') }}" method="post">
                                    ...
                                    <div class="card">
                                        <div class="card-header card-header-info">
                                                    <h1 class="card-title text-center">DATOS DEL REVISOR</h1>
                                        ...
                                        <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <input type="text" name="id_usuario_revisor" id="id_usuario_revisor">
                                                    <input type="text" name="usuario[]" id="nombre_funcionario">
                                                    <input type="text" name="cargo[]" id="cargo_funcionario">
                                                    <input type="text" name="unidad[]" id="unidad_funcionario">
                                                    <input type="text" name="firma[]" id="firma_funcionario">


                                                    <input type="text" name="nombre_funcionario_revisor" id="nombre_funcionario_revisor">
                                                </div>
                                        </div>
                                    </div> 
                                    <div class="card" >
                                            <div class="card-body">
                                                ...
                                                <div class="row" >                                                                         
                                                    <div class="col-12 col-sm-6 col-md-4 mt-3">
                                                        <input type="submit" value="Enviar Para Revision" class="btn btn-success">
                                                    </div>
